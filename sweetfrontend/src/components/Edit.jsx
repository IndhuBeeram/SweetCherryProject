        ...
        <div className='border border dark rounded container-fluid w-50 shadow-lg p-3 mb-5 mt-5 bg-white rounded'>
            ...
            <form>
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" value={data.name} id="name" onChange={handleChange} name="name" />
                </div>
                
                <div className="form-group">
                    <label htmlFor="age" className="col-form-label">Age:</label>
                    <input type="number" className="form-control" value={data.age} id="age" onChange={handleChange} name="age" />
                </div>
                <div className="form-group">
                    <label htmlFor="gender" className="col-form-label">Gender:</label>
                    <select className="form-control" value={data.gender} id="gender" onChange={handleChange} name="gender">
